...
public class BSTNParseProductResponseTest {
    ...
    public void setup(){
        ...
        String testInput = "\nwerqwrqwr\t submitAddtOcart \tqwerqwerqwerwr";
      ...
      //  bstnParseProductResponse = new BSTNParseProductAbstractResponse(stockTracker, "https://url.com");//"https://url.com", 0, s, d, attachmentCreater, httpRequestHelper, keywordSearchHelper, stockTracker);
    }

    @Test
    public void testInStock(){
        bstnParseProductResponse.parse(basicHttpResponse, attachmentCreater, false);
    ...
    @Test
    public void testOOS(){
        String testInput = "<span>sold out</span>";
