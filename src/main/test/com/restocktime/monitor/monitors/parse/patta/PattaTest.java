...
public class PattaTest {
  //  private Patta patta;
    ...
    public void setup(){
        ...
        pattaResponseParser = mock(PattaAbstractResponseParser.class);
     ...
     //   patta = new Patta("https://url.com", 0, notifications, attachmentCreater, httpRequestHelper, pattaResponseParser);
    }
    ...
    public void testNotifySearchTrue(){
       ...
       // patta.run(basicRequestClient, false);
        Mockito.verify(httpRequestHelper, Mockito.times(1)).performGet(eq(basicRequestClient), eq("https://url.com"));
        Mockito.verify(pattaResponseParser, Mockito.times(1)).parse(basicHttpResponse, attachmentCreater, false);
