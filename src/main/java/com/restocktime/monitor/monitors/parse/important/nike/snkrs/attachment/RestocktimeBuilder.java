...
public class RestocktimeBuilder {
    public static void addAttachment(AttachmentCreater attachmentCreater, String url, String rtUrl, String name, String launchType, String selectionEngine, String releaseDate, String launchDateStr, String sku, String region){
