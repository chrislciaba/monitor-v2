...
public class ShopifyCartResponseParser implements AbstractResponseParser {
    ...
    public ShopifyCartResponseParser(StockTracker stockTracker, KeywordSearchHelper keywordSearchHelper, String url, List<String> formatNames) {
        try {
