package com.restocktime.monitor.monitors.parse.important.offwhite.aco;
...
public class SubmitBillShip {
    ...
    public void submitBillShip(BasicRequestClient basicRequestClient, CloudflareRequestWrapper cloudflareRequestWrapper){
        while(true){
            BasicHttpResponse basicHttpResponse = cloudflareRequestWrapper.performPost(basicRequestClient, url, body);
